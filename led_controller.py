...
class LEDController:
    def __init__(self):
        self.leds = {
            'cpu': {'color': 'green','color2': 'red', 'state': False, 'gpio_pin': 17,'active' : True},
            'webcam': {'color': 'yellow','color2': 'DarkGoldenrod4', 'state': False, 'active' : True},
            'telegram': {'color': 'dodger blue','color2': 'blue4', 'state': False, 'active' : True},
    ...
    def webcam_blink(self):
        ...
        time.sleep(1.5)  # On for longer
        self.set_led_state('webcam', False)
        time.sleep(0.5)  # Off for shorter
